...
data_config = {
    ...
    'preprocessed_data_dir': '/home/ligen/PreprocessedImage',
    ...
    'new_annos_excluded_dir': os.path.join(BASE, 'annotations/new_annotations_excluded.csv'),
...
train_config['out_dir'] = os.path.join(train_config['RESULTS_DIR'], 'TiCNet/9_fold')
